  ...
  return (
    <div className="flex min-h-screen p-0 m-0 w-full ">
      ...
      >
        ...
        <nav className="flex flex-col gap-0 p-4 font-normal text-left space-y-1">
          <NavLink to="/login" />
          <NavLink
            to="/dashboard"
          ...
          >
            <HomeIcon size={20} /> <span className="pl-2">Dashboard</span>
          </NavLink>
          <NavLink
            to="/books"
            className={navLinkStyles}
            onClick={() => setSidebarOpen(false)}
          >
            <BookOpen size={20} /> <span className="pl-2">Books</span>
          </NavLink>
          <NavLink
            to="/borrow-return"
            className={navLinkStyles}
          ...
          >
            ...
            <span className="pl-2">Borrow/Return</span>
          </NavLink>
          {role=="admin" &&
            <>
              <NavLink
                ...
                onClick={() => setSidebarOpen(false)}
              >
                <Users size={20} /> <span className="pl-2">Members</span>
              </NavLink>
              <NavLink
                to="/staff"
                className={navLinkStyles}
                onClick={() => setSidebarOpen(false)}
              >
                <UserSquare size={20} /> <span className="pl-2">Staff</span>
              </NavLink>
              <NavLink
                to="/reports"
                className={navLinkStyles}
                onClick={() => setSidebarOpen(false)}
              >
                <LineChart size={20} /> <span className="pl-2">Reports</span>
              </NavLink>
              <NavLink
                to="/genres"
                className={navLinkStyles}
                onClick={() => setSidebarOpen(false)}
              >
                <Folder size={20} /> <span className="pl-2">Genres</span>
              </NavLink>
            </>
          }
        </nav>
